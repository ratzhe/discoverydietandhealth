      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="{{ route('nutricionist.dashboard') }}">Home</a></li>
            <li><a class="nav-link" href="{{ route('nutricionist.profile') }}">Meu Perfil</a></li>
            <li><a class="nav-link" href="{{ route('nutricionist.seepatients') }}">Ver Pacientes</a></li>
          </ul>
        </li>
